...
This package build recipe creates a conda package for the corona plugin you
...
3. Copy the "V-Ray" folder from your installation directory to conda_recipes/archive_files/cinema4d-corona-2025/win-64.
...
```
C:\Dev\deadline-cloud-samples\conda_recipes>submit-package-job cinema4d-corona-2025
...
```
C:\Dev\deadline-cloud-samples\conda_recipes>conda build cinema4d-corona-2025/recipe --no-test
...
...
04/10/2025  02:21 PM           232,806 cinema4d-corona-2025-0.conda
...
```
...
2. Copy the package you built into the `win-64` subdirectory.
    ```
    C:\Dev\deadline-cloud-samples\conda_recipes>copy output\win-64\cinema4d-corona-2025-h9490d1a_0.conda temp-local-channel\win-64
            1 file(s) copied.
    ...
    ```
