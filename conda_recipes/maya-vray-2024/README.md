...
- Download the `vray_adv_62002_maya2024_rhel8` full download file from [Chaos](https://download.chaos.com/downloads/23688/vray-maya-2024-62002-adv)\
...
1. Maya 2024 conda package by:
    - Follow Maya 2024 [README](../maya-2024/README.md) for getting archive file
    - running `./submit-package-job maya-2024` to build the package
