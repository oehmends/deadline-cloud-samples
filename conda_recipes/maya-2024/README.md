...
Download the Autodesk_Maya_2024_Linux_64bit.tgz full download file from Autodesk, and
...
install Maya 2024 on a freshly created EC2 instance as Administrator, and create an archive file
...
1. Launch a fresh Windows Server 2022 instance.
    ...
    3. Select "Microsoft Windows Server 2022 Base" for the AMI. (As of writing, Windows Server 2024 did not work with these instructions.)
...
3. Install Maya 2024 on the instance.
    1. Download the Maya 2024 Direct Downloads self-extracting files you got from Autodesk. For example, the files
       `Autodesk_Maya_2024_Windows_64bit_dlm_001_002.sfx.exe` and `Autodesk_Maya_2024_Windows_64bit_dlm_002_002.sfx.exe`.
...
5. Download the zip file to the `conda_recipes/archive_files` directory in your git clone of the
   ...
   submitting package build jobs, and update the Windows source artifact hash in the maya-2024 conda
